...
async fn main() {
    ...
    let reasoning_messages = vec![
        Message::new_human_message("If I have 15 apples and give 2/5 of them to my friend, how many apples do I have left?"),
    ];
    
    let reasoning_response = reasoning_deepseek.generate(&reasoning_messages).await.unwrap();
    ...
    let json_messages = vec![
        ...
        Message::new_human_message("List the top 3 programming languages with their primary use cases as a JSON array."),
    ];
